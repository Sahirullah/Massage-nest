    ...
    <>
        ...
        <div className="service-container">
          ...
          <div className="content-block" data-aos="slide-right">
            <div className="content-text">
              <h2 data-aos="zoom-in">Get Professional Thai Massage at Home in Dubai</h2>
          ...
          <div className="content-block center-text" data-aos="fade-up">
            <h2 data-aos="zoom-in">More Than Just a Massage</h2>
          ...
          <div className="content-block content-block-reverse" data-aos="slide-left">
            <div className="content-image" data-aos="zoom-in">
              <img src={imgTargeted} alt="Targeted Relief for Aches and Pains" />
            </div>
            <div className="content-text">
              <h2 data-aos="zoom-in">Targeted Relief for Aches and Pains</h2>
          ...
          <div className="content-block" data-aos="slide-right">
            <div className="content-text">
              <h2 data-aos="zoom-in">Traditional Thai Massage: Delivered at Home</h2>
          ...
          <div className="content-block center-text" data-aos="fade-up">
            <h2 data-aos="zoom-in">Enhanced Health and Vitality</h2>
      ...
      <section className="service-cta-section" style={{ backgroundImage: `url(${heroSec})` }} data-aos="fade-up">
        ...
        <div className="cta-content">
          ...
          <h2 data-aos="zoom-in">Energize Your Body and Mind with Holistic Thai Massage</h2>
